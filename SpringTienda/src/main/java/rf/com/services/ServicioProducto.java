...
public class ServicioProducto  implements IServicioProducto{
	 ...
	 */
	@Override
	public String[] insertRegistro(Producto producto) throws  DomainException{
		try { 
	...
	@Override
	public String[] updateRegistro(Producto producto) throws DomainException  {
		try{
			if(producto.isValidUpdate()) { 
				...
				throw new DomainException(Messagesmessages.PROERR_019);
			}catch(NumberFormatException e) {
				return Messagesmessages.PROERR_020;
			}
