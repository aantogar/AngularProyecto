...
public class ProductoController {
	...
	@PutMapping
	public String[] updateProducto(@RequestBody Producto producto) throws DomainException {
	...
	@PostMapping
	public String[] insertarRegistro( @RequestBody  Producto producto) throws DomainException{
