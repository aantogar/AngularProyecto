...
class CategoriaControllerTest {
     ...
     */
    @Test
    public void insertarRegistroService() throws DomainException,DAOException, ControllerException {
     ...
     */
    @Test
    public void insertarRegistroControllerr() throws DAOException,DAOException, DomainException, ControllerException {
     ...
     */
    @Test
    public void insertarRegistroEquals() throws DAOException, DomainException, ControllerException {
     ...
     */
    @Test
    public void insertarRegistroController() throws DAOException, DomainException, ControllerException {
    	categoria.setCat_descripcion(CAT_DESCRIPCION);
    	categoria.setCat_nombre(CAT_NOMBRE);
    	categoria.setId_categoria(ID_CATEGORIA2);
    	assertEquals(controller.insertarRegistro(categoria),servicio.readOne(ID_CATT));
    ...
    @Test
    public void readAllRegistros() throws DAOException, DomainException, ControllerException{
    	categoria.setCat_descripcion(CAT_DESCRIPCION);
    	categoria.setCat_nombre(CAT_NOMBRE);
    	categoria.setId_categoria(ID_CATEGORIA2);
     ...
     */
	@Test
	void testBorrarCategoria() throws DAOException, DomainException, ControllerException{
		categoria.setCat_descripcion(CAT_DESCRIPCION);
    	categoria.setCat_nombre(CAT_NOMBRE);
    	categoria.setId_categoria(ID_CATEGORIA2);
	 ...
	 */
	@Test
	void testBorrarCategoriaOther() throws DomainException,DAOException, ControllerException {
		categoria.setCat_descripcion(CAT_DESCRIPCION);
    	categoria.setCat_nombre(CAT_NOMBRE);
    	categoria.setId_categoria(ID_CATEGORIA2);
    	categoria.setCat_descripcion(CAT_DESCRIPCION2);
